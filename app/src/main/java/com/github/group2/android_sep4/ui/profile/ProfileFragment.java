...
import com.github.group2.android_sep4.ui.plantProfile.DeletePlantProfilePopup;
...
public class ProfileFragment extends Fragment {
    ...
    if(!viewModel.getCurrentUser().getValue().getPassword().equals(password.getText().toString())){
        ...
        Toast.makeText(getContext(), "No endpoint for this either", Toast.LENGTH_SHORT).show();
    }
    ...
    private void deleteAccount(View view) {
        ...
        deleteAccountPopup.showPopupWindow(view);
        if(deleteAccountPopup.isDeleteAccount()){
